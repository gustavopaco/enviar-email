package com.pacoprojects.enviaremail.email.generic;
...
public class GenericJavaMail {

    private String emailRemetente;
    private String tipoSMTPRemetente;
    ...
    public GenericJavaMail() {
    }

    public GenericJavaMail(String emailRemetente, String passwordRemetente, String nomeRemetente,
    ...
    private Properties getGeneralProperties(String tipoSMTP) {
        ...
        if (tipoSMTP.equalsIgnoreCase("gmail")) {
            ...
            properties.put("mail.smtp.ssl.checkserveridentity", "true"); // Checa a identidade do servidor de email
            properties.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory"); // Classe socket de conexao ao SMTP
        }
        return properties;
    }

    public void enviarEmail() throws MessagingException, IOException, InterruptedException {
        ...
        if (isHTML) {
            corpoEmail.setContent(conteudoEmail, HTML_CONTENT);
        } else {
